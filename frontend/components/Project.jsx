    ...
    >
      ...
      <div className="flex flex-col">
        <span className="self-end">
          {address && address.toLowerCase() == problemCreator
            ? "Mine"
            : problemCreator.substr(0, 4) +
              "..." +
              problemCreator.substr(problemCreator.length - 4)}
        </span>
        <h2 className="text-lg font-bold mb-5 ">{}</h2>
      ...
      <div className="flex flex-col">
        <div className="mb-4 flex flex-row items-center justify-between">
          ...
          <p className="text-sm self-end">
            By{" "}
            {address && address.toLowerCase() == solutionCreator
              ? "Mine"
              : solutionCreator.substr(0, 4) +
                "..." +
                solutionCreator.substr(solutionCreator.length - 4)}
          </p>
        </div>
