...
export class UserProjectOfferRating extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save UserProjectOfferRating entity without an ID"
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type UserProjectOfferRating must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("UserProjectOfferRating", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): UserProjectOfferRating | null {
    return changetype<UserProjectOfferRating | null>(
      store.get_in_block("UserProjectOfferRating", id.toHexString())
    );
  }

  static load(id: Bytes): UserProjectOfferRating | null {
    return changetype<UserProjectOfferRating | null>(
      store.get("UserProjectOfferRating", id.toHexString())
    );
  }
...
export class NewRemovalOffer extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save NewRemovalOffer entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type NewRemovalOffer must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("NewRemovalOffer", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): NewRemovalOffer | null {
    return changetype<NewRemovalOffer | null>(
      store.get_in_block("NewRemovalOffer", id.toHexString())
    );
  }

  static load(id: Bytes): NewRemovalOffer | null {
    return changetype<NewRemovalOffer | null>(
      store.get("NewRemovalOffer", id.toHexString())
    );
  }
...
export class RemovalOfferCancelled extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save RemovalOfferCancelled entity without an ID"
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type RemovalOfferCancelled must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("RemovalOfferCancelled", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): RemovalOfferCancelled | null {
    return changetype<RemovalOfferCancelled | null>(
      store.get_in_block("RemovalOfferCancelled", id.toHexString())
    );
  }

  static load(id: Bytes): RemovalOfferCancelled | null {
    return changetype<RemovalOfferCancelled | null>(
      store.get("RemovalOfferCancelled", id.toHexString())
    );
  }
...
export class RemovalOfferRated extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save RemovalOfferRated entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type RemovalOfferRated must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("RemovalOfferRated", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): RemovalOfferRated | null {
    return changetype<RemovalOfferRated | null>(
      store.get_in_block("RemovalOfferRated", id.toHexString())
    );
  }

  static load(id: Bytes): RemovalOfferRated | null {
    return changetype<RemovalOfferRated | null>(
      store.get("RemovalOfferRated", id.toHexString())
    );
  }
