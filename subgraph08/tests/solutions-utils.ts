...
export function createSolutionProjectCriteriaMetEvent(
  solutionId: BigInt
): SolutionProjectCriteriaMet {
  let solutionProjectCriteriaMetEvent = changetype<SolutionProjectCriteriaMet>(
    newMockEvent()
  )

  solutionProjectCriteriaMetEvent.parameters = new Array()

  solutionProjectCriteriaMetEvent.parameters.push(
    new ethereum.EventParam(
      "solutionId",
      ethereum.Value.fromUnsignedBigInt(solutionId)
    )
  ...
  return solutionProjectCriteriaMetEvent
}
