...
export class RateManagementOfferCall extends ethereum.Call {
  get inputs(): RateManagementOfferCall__Inputs {
    return new RateManagementOfferCall__Inputs(this);
  }

  get outputs(): RateManagementOfferCall__Outputs {
    return new RateManagementOfferCall__Outputs(this);
  }
}

export class RateManagementOfferCall__Inputs {
  _call: RateManagementOfferCall;

  constructor(call: RateManagementOfferCall) {
    this._call = call;
  }
...
export class RateManagementOfferCall__Outputs {
  _call: RateManagementOfferCall;
