...
export class ProblemRatingCriteriaMet extends ethereum.Event {
  get params(): ProblemRatingCriteriaMet__Params {
    return new ProblemRatingCriteriaMet__Params(this);
  }
}

export class ProblemRatingCriteriaMet__Params {
  _event: ProblemRatingCriteriaMet;

  constructor(event: ProblemRatingCriteriaMet) {
    this._event = event;
  }
